...
import CustomersTab from './components/customer/CustomersTab';
...
const YarisugiDashboard = () => {
  ...
  const {
    ...
    selectedCategory,
    setSelectedCategory,
    showFilters: showFaqFilters,
    setShowFilters: setShowFaqFilters,
    faqForm,
    setFaqForm,
    aiGeneratedFaqs,
    isGenerating,
  ...
  const {
    ...
    selectedCategory: knowledgeSelectedCategory,
    setSelectedCategory: setKnowledgeSelectedCategory,
    showFilters: showKnowledgeFilters,
    setShowFilters: setShowKnowledgeFilters,
    filteredKnowledgeEntries,
    categoryCounts: knowledgeCategoryCounts,
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto lg:ml-0">
          ...
          {activePage === 'faq' && (
            <FaqTab
              ...
              showFaqFilters={showFaqFilters}
              setShowFaqFilters={setShowFaqFilters}
              setShowFaqForm={setShowFaqForm}
              aiGeneratedFaqs={aiGeneratedFaqs}
              setAiGeneratedFaqs={setAiGeneratedFaqs}
              setShowAiGenerator={setShowAiGenerator}
              showFaqChat={showFaqChat}
              setShowFaqChat={setShowFaqChat}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="料金, プラン, 無料（カンマ区切りで入力）"
                      className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      id="isPublic"
                      checked={faqForm.isPublic}
                      onChange={(e) => setFaqForm(prev => ({...prev, isPublic: e.target.checked}))}
                      className="text-indigo-600"
                    />
                    <label htmlFor="isPublic" className="text-sm text-gray-700">公開する</label>
                  </div>
