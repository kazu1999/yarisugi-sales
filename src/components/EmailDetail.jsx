...
import { Mail, Calendar, User, FileText, Download, ArrowLeft, RefreshCw, Send, Bot } from 'lucide-react';
import { awsApiClient } from '../utils/awsApiClient';
import EmailReplyModal from './modals/EmailReplyModal';

const EmailDetail = ({ email, connection, onBack }) => {
